                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user-menu">
                                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <img src="{{ Storage::disk('public')->url('profile/'.Auth::user()->image) }}" class="user-image"
                                        alt="User Image" />
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>
                                        <a href="{{ route('setting.password') }}"> <i class="mdi mdi-account"></i> Password Update </a>
                                    </li>

                                    <li>
                                        <a href="{{ route('setting.index') }}"> <i class="mdi mdi-settings"></i> Account Setting </a>
                                    </li>
